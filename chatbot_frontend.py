...
if 'memory' not in st.session_state: 
    st.session_state.memory = cb.demo_memory() #** Modify the import and memory function() attributes initialize the memory
...
if input_text: 
    ...
    chat_response = cb.demo_conversation(input_text=input_text, memory=st.session_state.memory) #** replace with ConversationChain Method name - call the model through the supporting library
